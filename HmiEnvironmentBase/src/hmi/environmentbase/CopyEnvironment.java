...
is used (so, a {@link HmiRenderBodyAndFaceEmbodiment}), the copy() action involves taking the  
current Mpeg4config and actually applying it to the OpenGL head, and setting the morph targets 
of the graphical body (see {@link HmiFaceController#copy()}. For other environments it may again
involve some UDP or TCPIP communcation
